//===- ch0-cap-demo.c - Simple demo of C-API -----------------------===//
//
...
// RUN: ch0-capi-test 2>&1 | FileCheck %s
...
int main(int argc, char **argv) {
  ...
  // This adds dozens of MB of binary size over just the ch0 dialect.
  registerAllUpstreamDialects(ctx);
  mlirDialectHandleRegisterDialect(mlirGetDialectHandle__ch0__(), ctx);
