//===- ch1-cap-demo.c - Simple demo of C-API -----------------------===//
//
...
// RUN: ch1-capi-test 2>&1 | FileCheck %s
...
int main(int argc, char **argv) {
  ...
  // This adds dozens of MB of binary size over just the ch1 dialect.
  mlirRegisterAllDialects(ctx);
  mlirDialectHandleRegisterDialect(mlirGetDialectHandle__ch1__(), ctx);
